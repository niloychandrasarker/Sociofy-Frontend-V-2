...
import { getUserStoriesAction } from '../../Redux/Story/story.action';
...
const StoryCircle = ({ user }) => {
  ...
  const handleStoryClick = () => {
    if (user?.id) {
      dispatch(getUserStoriesAction(user.id));
    }
  };
    ...
    >
      <div className="relative">
        <Avatar
          ...
          src={user?.avatar || "https://cdn.pixabay.com/photo/2023/05/02/14/15/british-shorthair-7965411_640.jpg"}
